...
def train_test_split(X, y, hff, test_ratio=0.2, seed=None):
    # 检查样本和标签个数是否一致
...
def load_data(name):
    # 拼接文件路径
    dataPath = './benchmark/dataSet_' + name
    labelPath = './benchmark/labelSet_' + name
    featPath = './benchmark/featSet_' + name
